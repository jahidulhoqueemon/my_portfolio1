        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Foundational programming knowledge alongside strong communication and
                leadership skills from active club roles.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">Basic C++</div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Creative Graphics Design utilizing standard industry tools to 
                deliver compelling visual content and branding.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">Adobe Photoshop</div>
                <div className="what-tags">Canva</div>
                <div className="what-tags">Visual Content</div>
